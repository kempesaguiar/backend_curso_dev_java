...
public class LocacaoController {
	...
	@PostMapping("/{id}")
	public ResponseEntity<ResponseLocacaoDTO> devolveLocacao(@PathVariable Long id) throws FilmeNotFoundException {
		ResponseLocacaoDTO locacao = locacaoService.devolveLocacao(id);
		return ResponseEntity.status(HttpStatus.OK).body(locacao);
	}
